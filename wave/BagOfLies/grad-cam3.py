...
vidroot1 = '/media/ligong/Picasso/Share/cbimfs/BagOfLies/data/Finalised'
vidroot2 = '/media/ligong/Picasso/Datasets/BagOfLies/openface'
outroot = '/media/ligong/Picasso/Datasets/BagOfLies/attn_vis'
...
if __name__ == '__main__':
	...
	for filename in test_list:
		vidpath1 = os.path.join(vidroot1, f'{filename}/video.mp4')
		vidpath2 = os.path.join(vidroot2, filename, 'video.avi')
		csvpath = os.path.join(vidroot2, filename, 'video.csv')
		filename_ = filename.replace('/', '-')
		outpath = os.path.join(outroot, f'{filename_}')
		...
		np.save(os.path.join(outroot, f'{filename_}_au.npy'), feat)
		np.save(os.path.join(outroot, f'{filename_}_att.npy'), mask)
