...
class Net2(nn.Module):
    ...
    def __init__(self, params):
        ...
        if params.global_use_gru == 0:
            ...
            out_dim = params.global_embedding_dim
        else:
            self.use_gru = True
            self.glb_feat_dim = params.global_feature_dim
            self.glb_emb_dim = params.global_embedding_dim
            ...
            self.glb_gru = nn.GRU(params.global_embedding_dim, params.global_hidden_dim)
            self.glb_gru2out = nn.Linear(params.global_hidden_dim, params.global_out_dim)
            out_dim = params.global_out_dim
        self.cls = nn.Linear(out_dim, params.num_classes)
